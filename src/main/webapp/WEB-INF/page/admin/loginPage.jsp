...
<div id="div_background">
    <div id="div_nav">
        ...
        <ul id="div_peelPanel">
                 <li value="url(${pageContext.request.contextPath}/res/images/admin/loginPage/background-10.jpg)">
                <img src="${pageContext.request.contextPath}/res/images/admin/loginPage/background-mini-10.jpg"/>
            </li>
            ...
            <li value="url(${pageContext.request.contextPath}/res/images/admin/loginPage/background-9.jpg)">
                <img src="${pageContext.request.contextPath}/res/images/admin/loginPage/background-mini-9.jpg"/>
            </li>
            <li value="url(${pageContext.request.contextPath}/res/images/admin/loginPage/background-8.jpg)">
                <img src="${pageContext.request.contextPath}/res/images/admin/loginPage/background-mini-8.jpg"/>
            </li>
            <li value="url(${pageContext.request.contextPath}/res/images/admin/loginPage/background-7.jpg)">
                <img src="${pageContext.request.contextPath}/res/images/admin/loginPage/background-mini-7.jpg"/>
            </li>
            <li value="url(${pageContext.request.contextPath}/res/images/admin/loginPage/background-6.jpg)">
                <img src="${pageContext.request.contextPath}/res/images/admin/loginPage/background-mini-6.jpg"/>
            </li>
    ...
    <div id="div_main">
        <div id="div_head" class="div-right"><p>大创项目- <span>管理后台</span></p></div>
        <div id="div_content" class="div-right">
